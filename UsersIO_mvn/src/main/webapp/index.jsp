...
<link href="main/webapp/resources/favicon.ico" rel="icon" type="image/x-icon" />
<%
    ...
    <table>
        ...
        <tbody>
            ...
            <tr id="t-row" >
                ...
                <td><a href="update" value="getServletContext().setAttribute("idNumber", user.getIdNumber())" ><img src="main/webapp/resources/update.png" alt="Update" width="20px" ></a></td>
                <td><a href="delete" value="getServletContext().setAttribute("idNumber", user.getIdNumber())" ><img src="main/webapp/resources/bin-white.png" alt="Delete" width="20px" ></a></td>
            </tr>
            <%
                }
            }
